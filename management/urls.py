...
router.register('lwdtp', views.LWDTPViewSet)
...
urlpatterns = [
    ...
    path('data/<int:id>', views.browse_sensor_data, name='browse_sensor_data'),
    path('data/display/<int:id>/<str:filename>', views.display_sensor_data, name='display_sensor_data'),
    path('data/visualize/<int:id>/<str:filename>', views.visualize_sensor_data, name='visualize_sensor_data'),
    path('data/table/<int:id>/<str:filename>', views.table_sensor_data, name='table_sensor_data'),
    path('data/download/<int:id>/<str:filename>/<str:file_type>', views.download_sensor_data, name='download_sensor_data'),
    path('data/delete/<int:id>/<str:filename>', views.delete_datafile, name='delete_datafile'),

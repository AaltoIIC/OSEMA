...
router.register('variablenames', views.VariableViewSet)
router.register('defaultvariablenames', views.DefaultVariableViewSet)
...
urlpatterns = [
    ...
    path('report_failure', views.report_failure, name='report_failure'),

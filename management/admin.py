...
from .models import User, UserAdmin, Sensor, Type_of_sensor, Value_pair, Sample_rate, Sensitivity, Wlan, Nb_iot, HTTP, HTTPS, Update, MQTT, Data_format, Variable, Default_variable, Server
